...
/**
 * Reactive version of the {@link HazelcastInstance}
 */
public interface RxHazelcastInstance {
     ...
     * @return reactive distributed map instance with the specified name
     */
     ...
     * @return reactive distributed RingBuffer instance with the specified name
     */
     ...
     * @return reactive IAtomicLong proxy for the given name
     */
     ...
     * @return reactive IAtomicReference proxy for the given name
     */
